...
source('E:/Temp/RLogisticScore/commandMain2.R')
source('E:/Temp/RLogisticScore/combineDtaOut.r')
dtaDir='E:/Temp/dta'
outDir='E:/Temp/out'
commandMain2('E:/Temp/RLogisticScore/Reduced.Rdata',dtaDir,outDir)    ##need to clear folder \\proteome\Data\LogisticTempFiles\DtaOut and ...\Validations first!
#q(save="no")
